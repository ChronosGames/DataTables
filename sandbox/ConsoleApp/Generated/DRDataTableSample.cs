...
public sealed partial class DTDataTableSample : DataTable<DRDataTableSample>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DRDataTableSample? GetById(int id) => GetById(string.Empty, id);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryGetById(int id, out DRDataTableSample? result) => TryGetById(string.Empty, id, out result);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DRDataTableSample? GetByColor(ConsoleApp.ColorT color) => GetByColor(string.Empty, color);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryGetByColor(ConsoleApp.ColorT color, out DRDataTableSample? result) => TryGetByColor(string.Empty, color, out result);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DRDataTableSample? GetByIdAndInt16Value(int id, short int16Value) => GetByIdAndInt16Value(string.Empty, id, int16Value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryGetByIdAndInt16Value(int id, short int16Value, out DRDataTableSample? result) => TryGetByIdAndInt16Value(string.Empty, id, int16Value, out result);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IReadOnlyList<DRDataTableSample>? GetManyByNameAndBoolValue(string name, bool boolValue) => GetManyByNameAndBoolValue(string.Empty, name, boolValue);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static IReadOnlyList<DRDataTableSample>? GetManyByName(string name) => GetManyByName(string.Empty, name);
