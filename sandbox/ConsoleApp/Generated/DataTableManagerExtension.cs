...
public static class DataTableManagerExtension
{
    ...
    [Obsolete("Use DataTableManager.PreloadAllAsync or PreloadAsync(context) instead.")]
    ...
    /// 按优先级预加载数据表
    /// </summary>
    [Obsolete("Use DataTableManager.PreheatAsync or PreloadAsync(context) instead.")]
    [EditorBrowsable(EditorBrowsableState.Never)]
