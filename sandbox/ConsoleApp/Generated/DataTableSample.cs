...
{
    public sealed class DTDataTableSample : DataTable<DataTableSample>
    {

        private Dictionary<int, DataTableSample> m_Dict1 = new Dictionary<int, DataTableSample>();

        private MultiDictionary<int, short, DataTableSample> m_Dict2 = new MultiDictionary<int, short, DataTableSample>();

        public DataTableSample GetDataRow(int Id)
        {
            return m_Dict1[Id];
        }

        public DataTableSample GetDataRow(int Id, short Int16Value)
        {
            return m_Dict2[Id, Int16Value];
        }

        protected override void InternalAddDataRow(DataTableSample dataRow)
        {
