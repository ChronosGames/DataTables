...
");
 if (!string.IsNullOrEmpty(Namespace)) {
            ...
            this.Write("public static class DataTableManagerExtension\r\n{\r\n    public static readonly Dict" +
                    "ionary<string, string[]> Tables = new Dictionary<string, string[]>\r\n    {\r\n");
 foreach (var pair in DataTables)
{
            ...
            this.Write("    };\r\n\r\n    public static readonly Dictionary<string, Priority> Priorities = ne" +
                    "w Dictionary<string, Priority>\r\n    {\r\n");
 if (TablePriorities != null) {
   foreach (var kv in TablePriorities.OrderBy(k=>k.Key)) {
            ...
            this.Write("    };\r\n\r\n    public static IReadOnlyList<TableRegistration> TableRegistrations {" +
                    " get; } = new TableRegistration[]\r\n    {\r\n");
 foreach (var pair in DataTables)
{
    ...
    if (!pair.Value.Any())
    {
            ...
            this.Write(", async (context, cancellationToken) => await context.LoadAsync<");
            this.Write(this.ToStringHelper.ToStringWithCulture(pair.Key));
