...
using DataTables;");
 ...
 if (!string.IsNullOrEmpty(Namespace)) {
    ...
    for (var i = 1; i < dictIndex; i++)
    {
            ...
            this.Write("        OnGeneratedRowsRemoved();\r\n    }\r\n\r\n    partial void OnGeneratedRowsRemov" +
                    "ed();\r\n\r\n    #region Instance API\r\n");
    ...
    for (var i = 0; i < GenerationContext.IndexDefinitions.Count; i++)
    {
        ...
        var contextParameter = GetContextParameter(fields);

            this.Write("\n\n    [MethodImpl(MethodImplOptions.AggressiveInlining)]\n    public static ");
            this.Write(this.ToStringHelper.ToStringWithCulture(GenerationContext.DataRowClassName));
            this.Write("? GetBy");
            this.Write(this.ToStringHelper.ToStringWithCulture(suffix));
            this.Write("(DataTableContext ");
            this.Write(this.ToStringHelper.ToStringWithCulture(contextParameter));
            this.Write(", ");
 ...
 if (!string.IsNullOrEmpty(Namespace)) {
    ...
    var normalizedOutput = GenerationEnvironment.ToString().TrimEnd('\r', '\n');
    GenerationEnvironment.Clear();
    Write(normalizedOutput);
