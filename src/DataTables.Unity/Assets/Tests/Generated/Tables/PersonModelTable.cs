...
namespace DataTables.Tests.Tables
{
   public sealed partial class PersonModelTable : TableBase<PersonModel>, ITableUniqueValidate
   {
        ...
        {
            return new DataTables.Meta.MetaTable(typeof(PersonModel), typeof(PersonModelTable), "people",
                new DataTables.Meta.MetaProperty[]
                {
                    new DataTables.Meta.MetaProperty(typeof(PersonModel).GetProperty("LastName")),
                    new DataTables.Meta.MetaProperty(typeof(PersonModel).GetProperty("FirstName")),
                    new DataTables.Meta.MetaProperty(typeof(PersonModel).GetProperty("RandomId")),
                },
