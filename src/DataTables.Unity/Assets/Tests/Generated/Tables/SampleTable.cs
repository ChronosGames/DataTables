...
namespace DataTables.Tests.Tables
{
   public sealed partial class SampleTable : TableBase<Sample>, ITableUniqueValidate
   {
        ...
        {
            return new DataTables.Meta.MetaTable(typeof(Sample), typeof(SampleTable), "s_a_m_p_l_e",
                new DataTables.Meta.MetaProperty[]
                {
                    new DataTables.Meta.MetaProperty(typeof(Sample).GetProperty("Id")),
                    new DataTables.Meta.MetaProperty(typeof(Sample).GetProperty("Age")),
                    new DataTables.Meta.MetaProperty(typeof(Sample).GetProperty("FirstName")),
                    new DataTables.Meta.MetaProperty(typeof(Sample).GetProperty("LastName")),
                },
