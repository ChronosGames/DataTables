...
namespace DataTables.Tests.Tables
{
   public sealed partial class SequentialCheckMasterTable : TableBase<SequentialCheckMaster>, ITableUniqueValidate
   {
        ...
        {
            return new DataTables.Meta.MetaTable(typeof(SequentialCheckMaster), typeof(SequentialCheckMasterTable), "sequantial_master",
                new DataTables.Meta.MetaProperty[]
                {
                    new DataTables.Meta.MetaProperty(typeof(SequentialCheckMaster).GetProperty("Id")),
                    new DataTables.Meta.MetaProperty(typeof(SequentialCheckMaster).GetProperty("Cost")),
                },
