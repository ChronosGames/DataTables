...
namespace DataTables.Tests.Tables
{
   public sealed partial class SkillMasterTable : TableBase<SkillMaster>, ITableUniqueValidate
   {
        ...
        {
            return new DataTables.Meta.MetaTable(typeof(SkillMaster), typeof(SkillMasterTable), "skillmaster",
                new DataTables.Meta.MetaProperty[]
                {
                    new DataTables.Meta.MetaProperty(typeof(SkillMaster).GetProperty("SkillId")),
                    new DataTables.Meta.MetaProperty(typeof(SkillMaster).GetProperty("SkillLevel")),
                    new DataTables.Meta.MetaProperty(typeof(SkillMaster).GetProperty("AttackPower")),
                    new DataTables.Meta.MetaProperty(typeof(SkillMaster).GetProperty("SkillName")),
                    new DataTables.Meta.MetaProperty(typeof(SkillMaster).GetProperty("Description")),
                },
