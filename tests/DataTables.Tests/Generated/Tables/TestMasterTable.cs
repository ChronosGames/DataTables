...
namespace DataTables.Tests.Tables
{
   public sealed partial class TestMasterTable : TableBase<TestMaster>, ITableUniqueValidate
   {
        ...
        {
            return new DataTables.Meta.MetaTable(typeof(TestMaster), typeof(TestMasterTable), "TestMaster",
                new DataTables.Meta.MetaProperty[]
                {
                    new DataTables.Meta.MetaProperty(typeof(TestMaster).GetProperty("TestID")),
                    new DataTables.Meta.MetaProperty(typeof(TestMaster).GetProperty("Value")),
                },
